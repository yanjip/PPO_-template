...
def main(args, time, seed):
    ...
    env_ = env.subEnvironment(seed, ttile, fov_id)
    env_evaluate = env.subEnvironment(seed, ttile, fov_id)

    args.state_dim = env_.state_dim
    # args.action_dim = env.action_space.n
    args.action_dim = env_.action_dim
    args.max_episode_steps = env_._max_episode_steps  # Maximum number of steps per episode
    ...
    # while total_steps < args.max_train_steps:
        ...
        while not done:
            ...
            s_, r, done, _ = env_.step(a,episode_steps)
...
def test():
    env_ = env.subEnvironment()
    args.state_dim = env_.observation_space[0]
    # args.action_dim = env.action_space.n
    args.action_dim = env_.action_dim
    args.max_episode_steps = env_._max_episode_steps  # Maximum number of steps per episode
    evaluate_num = 0  # Record the number of evaluations
